...
def run_scenario(input_trace, expected_output_trace, setup, INITIAL, IDEMPOTENT, verbose=False):
    controller, sc, tracer = setup()

    # No fake/mock components, the input trace contains everything the Statechart needs!
