...
SCENARIOS = [
    {
        ...
        "input_events": [
            ...
            (3479898986, "crane_control.done_moving", None),
            (3979898986, "scheduler.set_target_x", 1000.0),
            (3979898986, "scheduler.set_target_y", 3.0),
            (3979898986, "scheduler.make_move", None),
            (7142176646, "crane_control.done_moving", None),
            (8627062426, "crane_control.done_moving", None),
            (10611948206, "crane_control.done_moving", None),
            (11111948206, "scheduler.set_target_x", 0.0),
            (11111948206, "scheduler.set_target_y", 2.0),
            (11111948206, "scheduler.make_move", None),
            (14274225866, "crane_control.done_moving", None),
            (15764175359, "crane_control.done_moving", None),
            (17754124852, "crane_control.done_moving", None),
            (18254124852, "scheduler.set_target_x", 1000.0),
            (18254124852, "scheduler.set_target_y", 4.0),
            (18254124852, "scheduler.make_move", None),
            (21416402512, "crane_control.done_moving", None),
            (22896198409, "crane_control.done_moving", None),
            (24875994306, "crane_control.done_moving", None),
        ],
        "output_events": [
            (0, "scheduler.ready", None),
            (0, "crane_control.move", 0.0),
            (500000000, "crane_control.hoist", 2.0),
            (1989949493, "crane_control.magnet_on", None),
            (2489949493, "crane_control.hoist", 100),
            (3979898986, "scheduler.ready", None),
            (3979898986, "crane_control.move", 1000.0),
            (7642176646, "crane_control.hoist", 3.0),
            (9127062426, "crane_control.magnet_off", None),
            (9627062426, "crane_control.hoist", 100),
            (11111948206, "scheduler.ready", None),
            (11111948206, "crane_control.move", 0.0),
            (14774225866, "crane_control.hoist", 2.0),
            (16264175359, "crane_control.magnet_on", None),
            (16764175359, "crane_control.hoist", 100),
            (18254124852, "scheduler.ready", None),
            (18254124852, "crane_control.move", 1000.0),
            (21916402512, "crane_control.hoist", 4.0),
            (23396198409, "crane_control.magnet_off", None),
            (23896198409, "crane_control.hoist", 100),
            (25375994306, "scheduler.ready", None),
        ],
    },
    {
        "name": "Emergency stop",
        "input_events": [
            ...
            (14824823051, "crane_control.done_moving", None),
        ],
        "output_events": [
            (0, "scheduler.ready", None),
            (0, "crane_control.move", 0.0),
            ...
            (11662545391, "scheduler.ready", None),
            (11662545391, "crane_control.move", 1000.0),
        ],
    },
]
